...
class CartController {
    ...
    try {
      ...
      if (!cartData) {
        ...
        return this.httpResponse.BAD_REQUEST(
          res,
          'No se proporcionaron datos para crear el carrito',
        );
      }
  ...
  getCarts = async (req, res) => {
    try {
      ...
      if (limit) {
        ...
        return this.httpResponse.OK(res, 'Tomando Carritos', {
          carts: limitedCarts,
        });
      }
      ...
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}error al traer los carritos`,
        { error: error.message },
      );
    }
  };
  ...
  getCartById = async (req, res) => {
    try {
      ...
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}error al traer el carrito `,
        { error: error.message },
      );
    }
  };
  ...
  updateCartById = async (req, res) => {
    try {
      ...
      const updatedCart = await this.cartService.updateCartById(
        cId,
        updateData,
      );
      ...
      if (!updatedCart) {
        ...
        return this.httpResponse.NOT_FOUND(
          res,
          `Error al actualizar la cart con id  ${cId} `,
        );
      }
      req.logger.info(`Cart actualizada con id ${cId}`, updatedCart);
      return this.httpResponse.OK(res, `Actualizada la cart con id ${cId} `, {
        data: updatedCart,
      });
    } catch (error) {
      ...
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}error al actualizar el carrito con el id proporcionado `,
        { error },
      );
    }
  };
  ...
  deleteCart = async (req, res) => {
    try {
      ...
      if (!deletedCart.success) {
        req.logger.warn(
          `La cart con id ${cId} no se encuentra o no se pudo borrar`,
        );
        return this.httpResponse.NOT_FOUND(
          res,
          `${this.enumError.DB_ERROR}La cart con id ${cId} no se encuentra o no se pudo borrar`,
        );
      }
      ...
      return this.httpResponse.OK(
        res,
        `La cart con id  ${cId} ha sido borrada `,
      );
    } catch (error) {
      req.logger.error('Error al eliminar el carrito:', error);
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}error al Eliminar el carrito con el id proporcionado `,
        { error },
      );
    }
  };
  ...
  deleteAllProductsInCart = async (req, res) => {
    try {
      ...
      if (!deleteAllProductsInCart.success) {
        req.logger.warn(
          `La cart con id ${cId} no se encuentra o no se pudo vaciar`,
        );
        return this.httpResponse.NOT_FOUND(
          res,
          `${this.enumError.DB_ERROR}La cart con id ${cId} no se encuentra o no se pudo vaciar`,
        );
      }
      ...
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}error al vaciar el carrito con el id proporcionado `,
        { error },
      );
    }
  };
  ...
  createProductInCart = async (req, res) => {
    try {
      ...
      if (!updatedCart) {
        ...
        return this.httpResponse.NOT_FOUND(
          res,
          `${this.enumError.INVALID_PARAMS}Error al crear o actualizar la cart con id  ${cId} `,
        );
      }

      req.logger.info(
        `El producto dentro de la cart con el id ${cId} ha sido creado`,
      );
      return this.httpResponse.OK(
        res,
        `El producto dentro de la cart con el id  ${cId} ha sido creado `,
      ...
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}error al Crear un producto dentro de la cart `,
        { error },
      );
    }
  };
  ...
  updateCartItemQuantity = async (req, res) => {
    try {
      ...
      if (!quantity || typeof quantity !== 'number') {
        ...
        return this.httpResponse.BAD_REQUEST(
          res,
          `La cantidad ${quantity} es invalida`,
        );
      }
      ...
      if (!updatedCart) {
        ...
        return this.httpResponse.NOT_FOUND(
          res,
          `${this.enumError.INVALID_PARAMS}Error al actualizar cart con id  ${cId} `,
        );
      }
      ...
      return this.httpResponse.OK(
        res,
        `La cart con id  ${cId} ha sido actualizada `,
        { data: updatedCart },
      );
    } catch (error) {
      req.logger.error(
        'Error al actualizar la cantidad del item en el controlador:',
        error,
      ); // Registro error
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}Error al actualizar la cantidad del item en el controlador:  `,
        { error },
      );
    }
  };
  ...
  deleteItemInCart = async (req, res) => {
    try {
      const { cId, pId } = req.params;
      const deleteItemInCart = await this.cartService.deleteItemInCart(
        cId,
        pId,
      );
      req.logger.info(
        `El item con id ${pId} en la cart ${cId} ha sido borrado`,
        deleteItemInCart,
      ); // Registro info
      return this.httpResponse.OK(
        res,
        `El item con id ${pId} en la cart ${cId} ha sido borrado `,
        { data: deleteItemInCart },
      );
    } catch (error) {
      req.logger.error(
        'Error al eliminar el producto del carrito en el controller:',
        error,
      ); // Registro error
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}Error al eliminar el producto del carrito en el controller `,
        { error },
      );
    }
  };
  ...
  purchaseCart = async (req, res) => {
    try {
      ...
      if (!purchaseCart) {
        req.logger.warn(
          `Error al comprar el carrito con id ${cId} en el controller`,
        );
        return this.httpResponse.BAD_REQUEST(
          res,
          `${this.enumError.DB_ERROR} Error al actualizar cart con id  ${cId} `,
        );
      }
      req.logger.info(`La cart con ${cId} ha sido comprada`, purchaseCart);
      return this.httpResponse.CREATED(
        res,
        `La cart con ${cId} ha sido comprada`,
      ...
      return this.httpResponse.ERROR(
        res,
        `${this.enumError.CONTROLER_ERROR}Error al comprar el carrito en el controller `,
        { error },
      );
    }
  };
